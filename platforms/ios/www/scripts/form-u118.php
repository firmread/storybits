...
function emailFormSubmission()
{
	...
	$subject = 'projectcode Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Project code:</b></td><td>' . htmlentities($_REQUEST["custom_U147"],ENT_COMPAT,'UTF-8') . '</td></tr>';
